...
- `--assets` string optional `beta`
  - Root folder of static assets to be served. Replaces [Workers Sites](/workers/configuration/sites/). Visit [assets](/workers/configuration/assets/) for more information.
- `--legacy-assets` string optional `deprecated`, use `--assets`
  - Root folder of static assets to be served.
- `--site` string optional `deprecated`
  - Root folder of static assets for Workers Sites.
    :::caution
    Workers Sites is deprecated. Please use [Workers Assets](/workers/configuration/assets/) or [Pages](/pages/})
    :::
